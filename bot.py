...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    intro = (
        "💬 Найти настоящее общение стало сложно.\n"
        "Тиндер и другие — это про свидания и свайпы. А что если хочется просто погулять и поговорить с кем-то рядом?\n\n"
        "👣 Как работает Gulyai:\n\n"
        "1️⃣ Нажми «Гулять» — откроется веб-приложение.\n"
        "2️⃣ Заполни анкету — укажи имя, интересы, район.\n"
        "3️⃣ Перейди в список людей рядом — увидишь, кто онлайн и может присоединиться."
    )
