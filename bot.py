...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    how_it_works = (
        "\n👣 Как работает Gulyai:\n\n"
        "1️⃣ Заполни анкету — укажи имя, адрес, интересы.\n"
        "2️⃣ Нажми “Готов к встрече” — увидишь людей рядом, кто тоже хочет выйти.\n"
        "3️⃣ Свяжись через Telegram — просто, быстро и без лишних платформ.\n"
    )
